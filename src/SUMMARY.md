...
[NO.28.tip： 无信息先验](./无信息先验.md)
[NO.29.tip： 广义线性模型](./广义线性模型.md)
[NO.30.tip： 线性回归](./线性回归.md)
[NO.31.tip： 逻辑回归](./逻辑回归.md)
[NO.32.tip： Probit回归](./Probit回归.md)
[NO.33.tip： 边界优化](./边界优化.md)
[NO.34.tip： 贝叶斯优化](./贝叶斯优化.md)
[NO.35.tip： 随机优化](./随机优化.md)
[NO.36.tip： 自然梯度下降](./自然梯度下降.md)
[NO.37.tip： 熵](./熵.md)
[NO.38.tip： 支持向量机](./支持向量机.md)
[NO.39.tip： 结构时间序列模型](./结构时间序列模型.md)
...
[NO.50.tip： 深度神经网络的正则化](./深度神经网络的正则化.md)